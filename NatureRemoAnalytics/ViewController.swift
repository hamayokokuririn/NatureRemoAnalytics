...
struct NatureDataLoader {
    ...
    static let accessToken = "zY-pzdwHUPOeOJV2dXYAKggeamFTjtgLLZk5zIqTpjs._TaMdLKZJG0vxm2rA2GCl5QrjVFa-tkGZDhvjHgofvY"
    let headers = {
...
struct WeatherDataLoader {
    let url = URL(string: "http://api.openweathermap.org/data/2.5/weather?q=Yono,JP&appid=d1bccf8708a43c8fd92ce48a83aaea2a&lang=ja&units=metric")!
    let headers = {
        ["Content-Type" : "application/json"]
    }()
